...
################# EXCEEDING ACTIVITY ##################
# I created the constants outside the functions

earth_acceleration_of_gravity = 9.8066500 # acceleration due to gravity in m/s^2
water_density = 998.2000000 # density of water in kg/m^3
water_dynamic_viscotity = 0.0010016 # viscosity of water (0.0010016 Pascal seconds)
...
def reynolds_number(hydraulic_diameter, fluid_velocity):
    reynolds_number = (water_density * hydraulic_diameter * fluid_velocity) / water_dynamic_viscotity
